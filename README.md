...
**NB** The document have a `.jsonl` extension because I have already preloaded the vectorized chunks of each document. This makes the process a little smooter and much faster.
